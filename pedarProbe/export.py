...
class FootHeatmap(object):
    ...
    def load_foot_mask(cls):
        ...
        Tip
        ---
        Every pixel of the left foot mask file :code:`data/left_foot_mask.png` is labelled by the pedar sensor ID it belongs to. The right foot mask is generated by flipping the left foot mask.
        ...
        mask_dir = os.path.join(mod_path, 'data/left_foot_mask.png')
